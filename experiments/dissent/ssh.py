...
def main():
    ...
    parser.add_argument(
        "--leader", action="store_true", help="SSH into the leader machine (default)",
    )
    parser.add_argument(
        "--server", action="store_true", help="SSH into the other server machine",
    )
    parser.add_argument(
        "--auditor", action="store_true", help="SSH into the other server machine",
    )
    parser.add_argument(
        "--client",
        type=int,
    ...
    if args.client is not None:
        ...
        hostname = data["auditor"]
    elif args.server:
        hostname = data["server"]
    else:
        hostname = data["leader"]
