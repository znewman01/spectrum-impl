...
def main():
    ...
    parser.add_argument("--client", type=int, nargs="?", default=0, help="SSH into some/(the nth) client machine")
    parser.add_argument("--worker", type=int, nargs="?", default=0, help="SSH into some/(the nth) worker machine")
